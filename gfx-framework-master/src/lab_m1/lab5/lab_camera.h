    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            auto rotationMat = glm::rotate(glm::mat4(1), angle, right);
            forward = glm::normalize((glm::vec3)(rotationMat * glm::vec4{ forward.x,forward.y,forward.z,1 }));
            up = glm::normalize((glm::vec3)(rotationMat * glm::vec4{ up.x,up.y,up.z,1 }));
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            auto rotationMat = glm::rotate(glm::mat4(1), angle, {0,1,0});
            forward = glm::normalize((glm::vec3)(rotationMat * glm::vec4{ forward.x,forward.y,forward.z,1 }));
            up = glm::normalize((glm::vec3)(rotationMat * glm::vec4{ up.x,up.y,up.z,1 }));
            right = glm::normalize((glm::vec3)(rotationMat * glm::vec4{ right.x,right.y,right.z,1 }));
        }
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            auto rotationMat = glm::rotate(glm::mat4(1), angle, forward);
            up = glm::normalize((glm::vec3)(rotationMat * glm::vec4{ up.x,up.y,up.z,1 }));
            right = glm::normalize((glm::vec3)(rotationMat * glm::vec4{ right.x,right.y,right.z,1 }));
